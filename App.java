...
public class App extends Game {
    ...
    // App creates the homscreen and the instruction screen. 
    // It also contains the main method that runs the code
...
class Instructions extends JFrame {
    ...
    public Instructions() {
        ...
        JLabel r = new JLabel("Fall in the pit, game over.");
        ...
        JLabel z = new JLabel("the arrow keys. The Wumpus is smart - if you fire an arrow");
        z.setFont(new Font("Arial", Font.PLAIN, 12));
        z.setBounds(xx, yy += 15, ww, hh); // x, y, w, h
        add(z);

        JLabel aa = new JLabel("and miss, he’ll move to a new location.");
