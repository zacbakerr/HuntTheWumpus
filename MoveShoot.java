...
public class MoveShoot extends Frame implements KeyListener {
  ...
  // MoveShoot has all of the moving and shooting logic as well 
  // as the initial locations and changing locations for the player, 
  // Wumpus, pit, and batas. MoveShoot also creats popup alerts for 
