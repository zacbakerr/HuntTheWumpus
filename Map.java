...
public class Map extends MoveShoot {
  ...
  public void paint(Graphics g) {
    ...
    g.drawString("Use WASD to move and the arrow keys to shoot!", 600, 240);
    g.drawString("Goal: Kill the Wumpus while avoiding the pit and bats!", 600, 260);

    g.drawString(text, 605, 150);
